    ...
    plugin(({ addComponents, addBase, theme }) => {
      ...
      addComponents({
        '.input': {
          ...
          borderRadius: 'var(--tw-input-border-radius)',
          boxShadow:
            '0 0 0 var(--tw-input-ring-width) var(--tw-input-ring-color)',
          display: 'block',
          fontSize: 'var(--tw-input-font-size)',
          ...
          '&:hover': {
            '--tw-input-ring-color': theme('colors.blue.300'),
          },
          '&:is(.has-input-error *)': {
            '--tw-input-ring-color': theme('colors.red.500'),
          },
          '&:focus': {
            '--tw-input-ring-color': theme('colors.blue.500'),
            outline: 'none',
          },
        },
      });
